...
export default function ChatPage() {
  ...
  return (
    <div className="min-h-screen bg-[var(--color-bg-secondary)] flex flex-col items-center justify-center p-6">
      <div className="max-w-md w-full bg-[var(--color-bg-primary)] rounded-[var(--radius-lg)] shadow-[var(--shadow-medium)] border border-[var(--color-border-primary)] overflow-hidden">
        {/* Header Banner */}
